...
public class LdapServerConnectorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, PrefConstants {

    private StringFieldEditor loginEditor;
    private StringFieldEditor passwordEditor;
    private Button testButton;

    public LdapServerConnectorPreferencePage() {
        super(GRID);
    ...
    public void createFieldEditors() {
        ...
        addField(new RadioGroupFieldEditor(P_LDAP_CONNECTION_LOGIN_MODE, Localization.getString("pref.connection.loginMode"), 2, new String[][] {
                { Localization.getString("pref.connection.loginMode.byLogin"), AUTHENTICATION_TYPE_LOGIN_PASSWORD },
                { Localization.getString("pref.connection.loginMode.byKerberos"), AUTHENTICATION_TYPE_KERBEROS } }, getFieldEditorParent()));
        ...
        boolean enabled = AUTHENTICATION_TYPE_LOGIN_PASSWORD.equals(Activator.getPrefString(P_LDAP_CONNECTION_LOGIN_MODE));
    ...
    protected void contributeButtons(final Composite buttonBar) {
        ...
        testButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                try {
                    performApply();
                    LdapServerConnector.getInstance().connect();
