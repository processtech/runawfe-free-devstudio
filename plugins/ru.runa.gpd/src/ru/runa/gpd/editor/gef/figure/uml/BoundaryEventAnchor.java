...
public class BoundaryEventAnchor extends AbstractConnectionAnchor implements GEFConstants {
	 public BoundaryEventAnchor(IFigure owner) {
	        super(owner);
	    }
	    ...
	    public Point getReferencePoint() {
	        ...
	        return new Point(bounds.x + bounds.width - GRID_SIZE, bounds.y + bounds.height - GRID_SIZE);
	    }
	    ...
	    public Point getLocation(Point reference) {
	        ...
	        if (ref.y == 0) {
	            return new Point((ref.x > 0) ? bounds.x + bounds.width : bounds.x - 2*GRID_SIZE, reference.y);
	        }
