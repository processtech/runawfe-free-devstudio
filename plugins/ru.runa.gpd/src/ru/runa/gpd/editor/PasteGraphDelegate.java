...
// Используется в JPDL (Gef) и BPMN (Graphiti) реализациях
public class PasteGraphDelegate implements IPasteGraph {
    ...
    public PasteGraphDelegate(IFeatureProvider fp, ProcessEditorBase editor) {
    ...
    public PasteGraphDelegate(ProcessEditorBase targetEditor, IFolder targetFolder) {
    ...
    private void adjustLocation(GraphElement ge) {
        ...
        if (ge instanceof AbstractTransition) {
            List<Point> bendPoints = ((AbstractTransition) ge).getBendpoints();
    ...
    public DiagramEditorPage getDiagramEditorPage() {
        return targetEditor.getDiagramEditorPage();
    }

    @Override
    public boolean canUndo() {
        return targetNodeMap != null && targetDefinition != null;
    }
    ...
    public static abstract class ExtraCopyAction {
        ...
        protected ExtraCopyAction(String groupName, String name) {
