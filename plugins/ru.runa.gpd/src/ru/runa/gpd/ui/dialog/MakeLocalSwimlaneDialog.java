...
public class MakeLocalSwimlaneDialog extends Dialog {
    private String name;
    private final ProcessDefinition processDefinition;
    private final Swimlane swimlane;
    private Text scriptingNameField;
    private String scriptingName;
    private Button RemoveRolesButton;
    private boolean RemoveRoles = true;

    public MakeLocalSwimlaneDialog(ProcessDefinition processDefinition, Swimlane swimlane) {
        super(Display.getCurrent().getActiveShell());
        this.processDefinition = processDefinition;
        this.name = swimlane.getName().substring(7);
        this.swimlane = swimlane;
        this.scriptingName = swimlane.getScriptingName().substring(7);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        /*
         * muchebola Кнопка с выбором, удалять глобальную роль или нет.
         */
        RemoveRolesButton = new Button(area, SWT.CHECK);
        RemoveRolesButton.setLayoutData(new GridData());
        RemoveRolesButton.setText(Localization.getString("MakeLocalWizard.deleteGlobalObject"));
        RemoveRolesButton.setSelection(true);
        RemoveRolesButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                updateButtons();
                RemoveRoles = RemoveRolesButton.getSelection();
            }
        });
        return area;
    }
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText(Localization.getString("SwimlaneWizard.makeGlobalLocal"));
    }
