...
public class VariableAccessPage extends ContentWizardPage {
    ...
    private boolean publicVisibilityComboEnabled = true;
    ...
    protected void createContent(Composite composite) {
        ...
        combo.setEnabled(publicVisibilityComboEnabled);
    ...
    public void setPublicVisibilityComboEnabled(boolean publicVisibilityComboEnabled) {
        this.publicVisibilityComboEnabled = publicVisibilityComboEnabled;
    }
}
