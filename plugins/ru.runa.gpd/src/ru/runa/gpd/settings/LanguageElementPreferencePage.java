...
public class LanguageElementPreferencePage extends FieldEditorPreferencePage implements PrefConstants {
    ...
    public void createFieldEditors() {
        ...
        if (NodeTypeDefinition.TYPE_NODE.equals(definition.getType())) {
        	...
        	case "scriptTask":
        		addField(new FontFieldEditor(P_BPMN_SCRIPTTASK_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_SCRIPTTASK_FONT), getFieldEditorParent()));
            	...
            	break;
        	case "userTask":
        		addField(new FontFieldEditor(P_BPMN_STATE_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_STATE_FONT), getFieldEditorParent()));
        		...
        		break;
        	case "endTokenEvent":
        		addField(new FontFieldEditor(P_BPMN_ENDTOKEN_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_ENDTOKEN_FONT), getFieldEditorParent()));
        		addColorField(store, P_BPMN_ENDTOKEN_FONT_COLOR);
        		break;
        	case "endEvent":
        		addField(new FontFieldEditor(P_BPMN_END_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_END_FONT), getFieldEditorParent()));
        		addColorField(store, P_BPMN_END_FONT_COLOR);
        		break;
        	case "startEvent":
        		addField(new FontFieldEditor(P_BPMN_STARTSTATE_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_STARTSTATE_FONT), getFieldEditorParent()));
        		addColorField(store, P_BPMN_STARTSTATE_FONT_COLOR);
        		break;
        	case "multiTask":
          		addField(new FontFieldEditor(P_BPMN_MULTITASKSTATE_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_MULTITASKSTATE_FONT), getFieldEditorParent()));
          		...
          		break;
        	case "multiProcess":
          		addField(new FontFieldEditor(P_BPMN_MULTISUBPROCESS_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_MULTISUBPROCESS_FONT), getFieldEditorParent()));
          		...
          		break;
        	case "subProcess":
          		addField(new FontFieldEditor(P_BPMN_SUBPROCESS_FONT, Localization.getString(PREF_COMMON_BPMN + P_BPMN_SUBPROCESS_FONT), getFieldEditorParent()));
