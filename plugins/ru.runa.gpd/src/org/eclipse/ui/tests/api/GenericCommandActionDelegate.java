//
// Source: https://git.eclipse.org/c/platform/eclipse.platform.ui.git/tree/tests/org.eclipse.ui.tests/Eclipse%20UI%20Tests/org/eclipse/ui/tests/api/GenericCommandActionDelegate.java
// Eclipse Wiki: https://wiki.eclipse.org/Platform_Command_Framework#Handlers
//    
/*******************************************************************************
...
/**
 * This action delegate can be used to specify a command with or without parameters be called from an &lt;action/&gt; specified in actionSets,
 * editorActions, viewActions, or popupMenus.
 */
public class GenericCommandActionDelegate
        implements IWorkbenchWindowActionDelegate, IViewActionDelegate, IEditorActionDelegate, IObjectActionDelegate, IExecutableExtension {
    ...
    public void setInitializationData(IConfigurationElement config, String propertyName, Object data) throws CoreException {
        ...
        if (data instanceof String) {
            ...
            Status status = new Status(IStatus.ERROR, "org.eclipse.ui.tests",
